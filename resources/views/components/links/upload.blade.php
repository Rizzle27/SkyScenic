<li class="order-lg-3 d-lg-none">
    ...
    @auth
        ...
        @elseif (auth()->user()->role == 'admin' || auth()->user()->role == 'superadmin')
            ...
            <div id="adminUploadOptions" class="admin-upload-options d-none flex-column justify-content-around align-items-center vw-100 bg-dark rounded-top-4 slide-out-down">
