<h1 class="text-light sticky-top text-center mx-auto my-0 w-100 h-100" id="skyScenicTitle">Sky<span
        class="text-ultramarine">Scenic</span></h1>
@unless (request()->is('/'))
    <div class="nav-button return-button position-absolute">
        <button class="btn text-light" onclick="history.back()">
...
@endunless
<div class="nav-button option-button position-absolute">
    <button id="optionButton" class="btn text-light">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
    ...
    <div id="profileNavContainer" class="slide-out-left position-fixed flex-column bg-customdark">
        <ul class="d-flex flex-column align-items-start my-4 mx-4 gap-4 list-unstyled">
            <p class="text-light fw-bold fs-5 m-0">Cuenta</p>
            <li class="text-light d-flex align-items-center gap-2">
                ...
                <a class="text-light text-decoration-none" href="{{ url('/usuarios/registrarse') }}">Registrar cuenta</a>
            </li>
            @guest
            <li class="text-light d-flex align-items-center gap-2">
        ...
        @auth
            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'superadmin')
                <ul class="d-flex mx-4 flex-column align-items-start my-4 gap-4 list-unstyled">
                    ...
                    <li class="text-light d-flex align-items-center gap-2">
                        ...
                        <a class="text-light text-decoration-none" href="{{ url('/admin/usuarios') }}">Usuarios</a>
                    </li>
                </ul>
            @endif
        @endauth
