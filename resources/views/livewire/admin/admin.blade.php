                ...
                <div class="d-flex text-center align-items-center">
                    <div class="col-1 div-avatar-container">
                        <img class="w-100 h-100 rounded-circle"
                            src="{{ asset('uploads/avatar_uploads/' . $user->avatar) }}"
                            alt="Avatar de . {{ $user->username }}">
                    </div>
                    <p class="col-6 m-0"><a class="text-decoration-none text-ultramarine"
                    ...
                    <button wire:click="deleteUser({{ $user->id }})" class="col-1 btn">
