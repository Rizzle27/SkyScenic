        ...
        <nav class="navbar navbar-expand-lg navbar-dark p-0 m-0 bg-dark">
            <ul class="list-unstyled d-flex justify-content-around align-items-end col-10 mx-auto">
                ...
                <li><button class="btn p-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-search text-light" viewBox="0 0 16 16">
                ...
                <li><a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-circle text-light" viewBox="0 0 16 16">
